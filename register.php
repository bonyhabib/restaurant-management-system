...
<div class="logo" >
  <h1 style="position:absolute; color:orange; margin-left: 437px; 
  margin-top: -20px;font-size: 50px;"><strong>HABIB's KITCHEN</strong></h1>
      ...
      <form class="formValidate" id="formValidate" method="post" action="routers/register-router.php" novalidate="novalidate" class="col s12">
        <div class="row">
          <div class="input-field col s12 center">
            <h4>Sign Up</h4>
            <p class="center">Register as a new account!</p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="input-field col s12">
			<a href="javascript:void(0);" onclick="document.getElementById('formValidate').submit();" class="btn waves-effect waves-light col s12">Submit</a>
          </div>
          <div class="input-field col s12">
  ...
  <div class="foot" style="position: absolute; color:white; font-size: 20px; margin-left: -150px; margin-top:-10px ">
