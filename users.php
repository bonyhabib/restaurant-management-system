    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"> Food Menu</a>
            </li>
                <li class="no-padding">
            ...
            <li class="bold active"><a href="users.php" class="waves-effect waves-cyan"> Users Detail</a>
            </li>			
        </ul>
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Users Detail</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <p class="caption">Modify Users from here...</p>
...
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="price">Verified/Not Verified</th>
                        <th data-field="price">Enable/Disable</th>
                        <th data-field="price">Debit Card</th>						
                      </tr>
                    </thead>
			  ...
			  <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Modify Details
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/add-users.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Add New User/Admin</h4>
              </div>
              <div>
<table>
                    <thead>
			  ...
			  <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Add New
