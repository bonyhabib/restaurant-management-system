    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"> Order Food</a>
            </li>
                <li class="no-padding">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Order Food</h5>
              </div>
            </div>
          </div>
        </div>
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="place-order.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h5 class="header">Food Menu Items ------------------------------------</h5>
              </div>
              <div>
