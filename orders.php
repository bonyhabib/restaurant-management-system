    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"></i> Order Food</a>
            </li>
                <li class="no-padding">
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Orders Detail</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <p class="caption">List of previous orders with details</p>
