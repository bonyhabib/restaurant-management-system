    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"> Food Menu</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active">Orders Detail</a>
            ...
            <li class="bold"><a href="users.php" class="waves-effect waves-cyan"> Users Detail</a>
            </li>				
        </ul>
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">All Orders by Customer</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <p class="caption">(Delivered/ Cancelled by Customer/ Yet to be Delivered/ Paused)</p>
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						while($row1 = mysqli_fetch_array($sql1))
						{
                            ...
                            <span>$ '.$row1['price'].'</span>
								...
								if(!$deleted){
								echo '<button class="btn waves-effect waves-light right submit" type="submit" name="action">Modify Status
